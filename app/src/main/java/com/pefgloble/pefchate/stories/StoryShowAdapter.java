...
import com.pefgloble.pefchate.activities.stories.StoriesReplyActivity;
import com.pefgloble.pefchate.activities.stories.StoriesSeenListActivity;
import com.pefgloble.pefchate.app.AppConstants;
import com.pefgloble.pefchate.app.WhatsCloneApplication;
import com.pefgloble.pefchate.fragments.StoryFragment;
...
import com.pefgloble.pefchate.ui.SpannyBen;
...
public class StoryShowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void configureVideoViewHolder(VideoViewHolder holder, int position) {
        ...
        if (storyModel.getFile().startsWith("/storage")) {
            ...
            if (!StoriesController.checkIfUserBlockedExist(storyModel.getUserId()) && !storyModel.getUserId().equals(PreferenceManager.getInstance().getID(AGApplication.getInstance()))) {
                if (StoriesController.checkIfSingleStoryWaitingExist(storyModel.get_id()))
        ...
        if (storyModel.getUserId().equals(PreferenceManager.getInstance().getID(storyFragment.getContext()))) {
            ...
            holder.seen_counter.setText(String.format(Locale.getDefault(),"%d", storyModel.getSeenList().size()));
        } else {
    ...
    private void configureImageViewHolder(ImageViewHolder holder, int position) {
        ...
        RequestBuilder<Drawable> thumbnailRequest = Glide.with(AGApplication.getInstance())
...
//        holder.getSeen_counter().setText(storyModel.getSeenList().size());
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageViewHolder(View itemView) {
            ...
            ///storage/emulated/0/Android/data/com.pefgloble.pefchate/cache/2021-04-06-20:54:17.jpg
