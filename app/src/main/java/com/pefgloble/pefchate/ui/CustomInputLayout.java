...
import com.pefgloble.pefchate.util.AssertedSuccessListener;
import com.pefgloble.pefchate.util.SettableFuture;
import com.pefgloble.pefchate.util.Util;
import com.pefgloble.pefchate.util.ViewUtil;
...
public class CustomInputLayout extends LinearLayout
    ...
    public void onFinishInflate() {
        ...
        this.btnSend=findViewById(R.id.send_buttonn);
...
/*    public void clearQuote() {
    ...
    private long onRecordHideEvent(float x) {
        com.pefgloble.pefchate.helpers.ListenableFuture<Void> future = (com.pefgloble.pefchate.helpers.ListenableFuture<Void>) slideToCancel.hide(x);
    ...
    private static class SlideToCancel {
        ...
        public ListenableFuture<Void> hide(float x) {
            ...
            return (com.pefgloble.pefchate.helpers.ListenableFuture<Void>) future;
        }
