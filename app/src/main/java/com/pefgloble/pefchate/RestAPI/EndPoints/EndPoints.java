package com.pefgloble.pefchate.RestAPI.EndPoints;
...
public class EndPoints {
    ...
    public static final String CHECK_ACCOUNT_KIT = "auth/accountKit";
    ...
    public static final String DELETE_STATUS = "users/deleteStatus";
    ...
    public static final String CURRENT_STATUS = "users/setCurrentStatus";
    ...
    public static final String GET_SINGLE_CONVERSATION="chats/getSingleConversation/{otherUserId}";
    public static final String GET_SINGLE_GROUP_CONVERSATION="chats/getSingleGroupConversation/{groupId}";
    public static final String GET_ALL_MESSAGE ="chats/all" ;
