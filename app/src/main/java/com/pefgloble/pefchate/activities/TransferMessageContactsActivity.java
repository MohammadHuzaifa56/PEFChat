...
import com.pefgloble.pefchate.adapter.TransferMessageContactsAdapter;
...
public class TransferMessageContactsActivity extends BaseActivity {
    ...
    private List<UsersModel> mContactsModelList=new ArrayList<>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        usersModel.setUsername("Huzaifa");
        usersModel.set_id("6041b7d102ca2d000410939e");

        mContactsModelList.add(usersModel);
