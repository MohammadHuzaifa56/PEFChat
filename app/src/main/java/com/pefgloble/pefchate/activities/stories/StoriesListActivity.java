...
import com.pefgloble.pefchate.adapter.StoriesListAdapter;
...
public class StoriesListActivity extends BaseActivity implements LoadingData, RecyclerView.OnItemTouchListener, ActionMode.Callback {
    ...
    public void showStories(RealmResults<StoryModel> storyModels) {
        storiesList.setVisibility(View.VISIBLE);
        RealmList<StoryModel> modelRealmList = new RealmList<>();
        modelRealmList.addAll(storyModels);
        storiesListAdapter.setStoryModelList(modelRealmList);
