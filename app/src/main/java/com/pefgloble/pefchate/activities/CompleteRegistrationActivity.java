...
public class CompleteRegistrationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (PreferenceManager.getInstance().getToken(this) != null) {
            WhatsCloneApplication.initRealm();
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, ProfileResponse> {
        ...
        private ProfileResponse uploadFile() {
            ...
            if (requestFile == null) {
                ...
                mDisposable.add(APIHelper.initializeUploadFiles().uploadUserImage(MultipartBody.Part.createFormData("file", file.getName(), requestFile), PreferenceManager.getInstance().getID(CompleteRegistrationActivity.this)).subscribe(response -> {
