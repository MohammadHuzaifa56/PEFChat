...
import com.pefgloble.pefchate.helpers.Mp4Cutter;
...
import com.pefgloble.pefchate.interfaces.VideoTimelineViewListener;
...
import com.pefgloble.pefchate.ui.VideoSeekBarView;
import com.pefgloble.pefchate.ui.VideoTimelineView;
...
public class VideoEditorActivity extends BaseActivity implements SurfaceHolder.Callback, InputGeneralPanel.Listener {
    ...
    public void send() {
        ...
        AppHelper.ShowProgressDialog(this, "Loading");
            ...
            protected void onPostExecute(String path) {
                ...
                if (path == null) {
                    ...
                    if (forStory) {
                        ...
                        try {
                            String storyId = getStoryId(PreferenceManager.getInstance().getID(VideoEditorActivity.this), realm);
                            if (storyId == null) {

                                String lastID = RealmBackupRestore.getStoryLastId();
                                realm.executeTransactionAsync(realm1 -> {

                                    UsersModel storyOwner = realm1.where(UsersModel.class).equalTo("_id", PreferenceManager.getInstance().getID(VideoEditorActivity.this)).findFirst();
