...
public class AppConstants {
    ...
    public static final String FIRE_BASE_TOPIC = AGApplication.getInstance().getPackageName();
    static final boolean CRASH_LYTICS = false;//this is crashlytics if you have an account on fabric.io but don't forget to change the key in the manifests file
    ...
    public static final String JOINED_MESSAGE_SMS = String.valueOf((R.string.hi_i_m_using_app) +(R.string.app_name));
    public static final String INVITE_MESSAGE_SMS = AGApplication.getInstance().getString(R.string.Hello_get) + AGApplication.getInstance().getString(R.string.app_name) + AGApplication.getInstance().getString(R.string.so_you_can_easly);// this is the sms to invite  friends
  ...
  //  public static final String DatabaseName =PreferenceManager.getInstance().getString(R.string.app_name) + PreferenceManager.getInstance().getToken(getInstance()) + "_db" + ".realm";
    /**
    ...
    public static final String DatabaseName = "PEFChat" + PreferenceManager.getInstance().getToken(AGApplication.getInstance()) + "_db" + ".realm";
    ...
    //public static final String FIRE_BASE_TOPIC = WhatsCloneApplication.getInstance().getPackageName();
    /**
     * Status constants
     */
  ...
  //  public static String EXPORT_REALM_FILE_NAME = getInstance().getString(R.string.app_name) + "_msgstore.realm";
     ...
     */
    public static final String CREATE_GROUP = "user create group";  // and for those you must change them for  security  reasons but make sure to put string
    public static final String LEFT_GROUP = "user left group";
    ...
    /**
     * Socket io constants class
     */
    public final class SocketConstants {
        public static final String SOCKET_CHECK_STATE = "socket_check_state";
        ...
        public static final String SOCKET_MEMBER_IS_TYPING = "member_typing";
        public static final String SOCKET_MEMBER_IS_STOP_TYPING = "member_stop_typing";
        //messages
        public static final String SOCKET_NEW_USER_MESSAGE = "new_user_message_from_server";
        public static final String SOCKET_NEW_USER_MESSAGE_TO_SERVER = "new_user_message_to_server";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_MESSAGES_AS_DELIVERED = "update_status_offline_messages_as_delivered";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_MESSAGES_AS_SEEN = "update_status_offline_messages_as_seen";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_MESSAGES_AS_FINISHED = "update_status_offline_messages_as_finished";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_MESSAGES_EXIST_AS_FINISHED = "update_status_offline_messages_exist_as_finished";
        //received messages status updates
        public static final String SOCKET_IS_MESSAGE_DELIVERED = "update_status_messages_as_delivered";
        public static final String SOCKET_IS_MESSAGE_SEEN = "update_status_messages_as_seen";
        //messages
        //stories
        public static final String SOCKET_NEW_USER_STORY = "new_user_story_from_server";
        public static final String SOCKET_NEW_USER_STORY_TO_SERVER = "new_user_story_to_server";
        public static final String SOCKET_NEW_EXPIRED_STORY_TO_SERVER = "new_expired_story_from_server";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_STORY_AS_EXPIRED = "update_status_offline_stories_as_expired";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_STORY_AS_SEEN = "update_status_offline_stories_as_seen";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_STORY_AS_FINISHED = "update_status_offline_stories_as_finished";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_STORY_EXIST_AS_FINISHED = "update_status_offline_stories_exist_as_finished";
        //received stories status updates
        public static final String SOCKET_IS_STORY_SEEN = "update_status_stories_as_seen";
        //stories

        //calls
        public static final String SOCKET_NEW_USER_CALL = "new_user_call_from_server";
        public static final String SOCKET_NEW_USER_CALL_TO_SERVER = "new_user_call_to_server";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_CALL_AS_SEEN = "update_status_offline_calls_as_seen";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_CALL_AS_FINISHED = "update_status_offline_calls_as_finished";
        public static final String SOCKET_UPDATE_STATUS_OFFLINE_CALL_EXIST_AS_FINISHED = "update_status_offline_calls_exist_as_finished";
        //received call status updates
        public static final String SOCKET_IS_CALL_SEEN = "update_status_call_as_seen";
        //for notify user changes
        public static final String SOCKET_IMAGE_PROFILE_UPDATED = "update_image_profile";
        public static final String SOCKET_NEW_USER_JOINED = "new_user_has_joined";
