...
public class PreferenceManager {
    ...
    private final String KEY_REGISTERED_USER = "KEY_REGISTERED";

    private final String KEY_NEW_USER = "KEY_NEW_USER";
    private final String KEY_WALLPAPER_USER = "KEY_WALLPAPER_USER";
    private final String KEY_NAME_USER = "KEY_NAME_USER";
    private final String KEY_DESIG_USER = "KEY_DESIG_USER";
    ...
    public void setImageUrl(Context mContext, String image) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = mSharedPreferences.edit();
    ...
    public void setUserName(Context mContext, String name) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = mSharedPreferences.edit();
    ...
    public String getName(Context mContext) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        return mSharedPreferences.getString(KEY_NAME_USER, "Name");
    }

    public void setUserDesig(Context mContext, String name) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putString(KEY_DESIG_USER, name);
        editor.apply();
    }
    public String getUserDesig(Context mContext) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        return mSharedPreferences.getString(KEY_DESIG_USER, "Designation");
    }
    ...
    public Boolean getRegistered(Context mContext){
        mSharedPreferences=mContext.getSharedPreferences(KEY_REGISTERED_USER,Context.MODE_PRIVATE);
        return mSharedPreferences.getBoolean("registered",false);
    }
    public void setRegistered(Context mContext,boolean registered){
        mSharedPreferences=mContext.getSharedPreferences(KEY_REGISTERED_USER,Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=mSharedPreferences.edit();
     ...
     *
     * @param ID this is the first parameter for setSocketID  method
     * @return return value
     */
    public void setSocketID(Context mContext, String ID) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putString("socketId", ID);
        editor.apply();
    }
    public String getSocketID(Context mContext) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
     ...
     * @return return value
     */
    public String getRoomID(Context mContext) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        return mSharedPreferences.getString("call_id", null);
    }

    /**
     * method to putRoomID
     *
     * @param call_id this is the first parameter for setID  method
     * @return return value
     */
    public void putRoomID(Context mContext, String call_id) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = mSharedPreferences.edit();
     ...
     * @return return value
     */
    public void setAccountKitState(Context mContext, Boolean bo) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putBoolean("accountKitEnabled", bo);
        editor.apply();
    }
     ...
     * @return return value
     */
    public boolean getAccountKitState(Context mContext) {
        mSharedPreferences = mContext.getSharedPreferences(KEY_USER_PREF, Context.MODE_PRIVATE);
        return mSharedPreferences.getBoolean("accountKitEnabled", false);
    }
