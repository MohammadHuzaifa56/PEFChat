...
public class StoriesListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RealmList<StoryModel> storyModelList;
    ...
    public void setStoryModelList(RealmList<StoryModel> storyModelList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        storyViewHolder.getSeen_counter().setText(String.valueOf(item.getSeenList().size()));
        ...
        StoryViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                if (!storyModel.isUploaded()) {
                    ...
                    if (storyModel.getStatus() == AppConstants.IS_WAITING) return;
